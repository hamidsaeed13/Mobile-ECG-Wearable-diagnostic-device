...
adc_wreg(GPIO, 0);
 ...
 // Set the first two channels to input signal
  for (int i = 1; i <= 8; ++i) {
   ...
   //adc_wreg(CHnSET + i,0x05); //disable this channel
  }
 /* for (int i = 2; i <= 2; ++i) {
 ...
 Serial.print("CH1SET: ");
 Serial.println(adc_rreg(CH1SET));

 Serial.print("CH2SET: ");
 Serial.println(adc_rreg(CH2SET));
  Serial.print("CH3SET: ");
 Serial.println(adc_rreg(CH3SET));
  Serial.print("CH4SET: ");
 Serial.println(adc_rreg(CH4SET));
  Serial.print("CH5SET: ");
 Serial.println(adc_rreg(CH5SET));
  Serial.print("CH6SET: ");
 Serial.println(adc_rreg(CH6SET));
 Serial.print("CH7SET: ");
 Serial.println(adc_rreg(CH7SET));
  Serial.print("CH8SET: ");
 Serial.println(adc_rreg(CH8SET));
